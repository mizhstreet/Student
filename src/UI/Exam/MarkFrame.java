...
public class MarkFrame extends javax.swing.JFrame {
    ...
    public MarkFrame(Exam atd, boolean isMarked) {
        ...
        jLabel3.setText(atd.getName());
            ...
            try {
                ...
                Logger.getLogger(MarkFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
            for (Student student : listPerson) {
                Object[] data = {student.getStudentId(), student.getRollNo(),student.getFname(),student.getLname(),"",""};
                tableModel.addRow(data);
            }          
        tblAttend.setModel(tableModel);
        tblAttend.setRowHeight(25);
        ResultSet rs2 = new StudentDB().getStudentHasMark(atd);
            try {
                while(rs2.next()){
                    int rowCount = tblAttend.getRowCount();
                    for (int j = 0; j < rowCount; j++) {
                        int sid = Integer.parseInt(tblAttend.getValueAt(j, 0)+"");
                        if( sid == rs2.getInt("student_id")){
                            tblAttend.setValueAt(rs2.getInt("mark") == -1 ? "" : rs2.getInt("mark"), j, 4);
                            tblAttend.setValueAt(rs2.getString("remark"), j, 5);
                        }
                    }
                }
            } catch (SQLException ex) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mark Management");
        ...
        tblAttend.setFont(new java.awt.Font("Miriam Mono CLM", 1, 18)); // NOI18N
    ...
    public void insertToExamResult(){
        ...
        for (int i = 0; i < rowCount; i++) {           
            ...
            er.setExamID(atd.getExam_id());
            er.setStudentID(Integer.parseInt(tblAttend.getValueAt(i, 0).toString()));
